  ...
  <div class="container">
    <div class="row align-items-center justify-content-between d-flex">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="index.jsp" class="board">Home</a></li>
          <li><a href="board.jsp" class="board">Freeboard</a></li>
          <li class="menu-has-children"><a href="" class="board">Pages</a>
            <ul>
